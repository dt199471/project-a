...
- 物件の登録・編集・削除
- 物件一覧表示
- 検索・フィルタリング（価格、エリア、最寄り駅、間取り、面積、築年数）
- 画像アップロード（base64形式）
- ソート機能（作成日、価格、住所、面積）
- ページネーション（20件ずつ表示）
...
- [x] 専有面積での範囲指定
- [x] 築年数での範囲指定
- [ ] 駅からの距離でのフィルタリング（将来対応）
- [x] 複数条件の組み合わせ検索
- [ ] 検索条件の保存機能（将来対応）
- [ ] 検索履歴（将来対応）

#### 2-2. ソート・表示オプション ✅ 部分完了
**実装内容**:
- [x] 価格の安い順・高い順
- [x] 新着順・更新順
- [x] 面積の広い順・狭い順
