  ...
  return (
    <div className="bg-white border border-gray-200">
      ...
      <div className="relative h-80 w-full bg-gray-100 overflow-hidden">
        ...
        {/* MODERN STANDARDロゴオーバーレイ */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="text-white text-center">
            <p className="text-3xl font-light tracking-wider">MODERN STANDARD</p>
            <p className="text-xs tracking-widest mt-1">by RENOSY</p>
          </div>
        </div>
      </div>
      ...
      {/* 物件情報セクション */}
      <div className="p-8">
        <h2 className="text-2xl font-light text-gray-900 mb-8 leading-relaxed">
          {property.title}
        </h2>
